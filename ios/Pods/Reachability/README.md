...
This sample will use `NSNotification`s to notify when the interface has changed. They will be decasared on the **MAIN THREAD**, so you *can* do UI updates from within the function.
