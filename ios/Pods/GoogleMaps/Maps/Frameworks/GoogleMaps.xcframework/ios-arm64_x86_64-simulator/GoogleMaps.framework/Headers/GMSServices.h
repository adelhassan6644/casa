...
/** Returns the version for this release of the Google Maps SDK for iOS. For softwareCasa, "1.0.0". */
+ (NSString *)SDKVersion;

/**
 * Returns the long version for this release of the Google Maps SDK for iOS. For softwareCasa, "1.0.0
 * (102.1)".
 */
