import 'package:casa/features/ratting/repo/ratting_repo.dart';
import 'package:casa/features/reservations/model/reservation_model.dart';
    ...
    if (ratting != -1) {
      try {
        ...
        var body = {
          ...
          "id": reservation.id,
          "sub_service_id":reservation.subServiceID,
          "rating": ratting! + 1,
